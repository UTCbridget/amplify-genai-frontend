...
export const Regenerate: FC<Props> = ({ onRegenerate }) => {
  ...
  return (
    <div className="fixed bottom-4 left-0 right-0 ml-auto mr-auto w-full px-2 sm:absolute sm:bottom-8 sm:left-[280px] sm:w-1/2 lg:left-[200px]">
      ...
      <button
        className="flex h-12 gap-2 w-full items-center justify-center  border border-b-neutral-300 bg-neutral-100 text-sm font-semibold text-neutral-500 dark:border-none dark:bg-blue-500 dark:text-neutral-200"
