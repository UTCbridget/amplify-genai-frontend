...
export const ActiveAssistantsList: FC<Props> = ({}) => {
    ...
    return (
        <div ref={ref} className="relative" style={{width:'220px'}}>
            {isOpen && (
                <div
                    className="w-full absolute bottom-0 mb-9 border border-neutral-200 overflow-scroll bg-white dark:border-neutral-600 dark:bg-[#051228]"
                    style={{height: "200px"}}
                >
                    {availableAssistants.map((assistant, index) => (
                        <div
                            ...
                            className="flex flex-row items-center justify-center text-black hover:opacity-50 mt-6 dark:text-white dark:border-neutral-600 gap-3 py-2 px-4 dark:bg-[#051228] md:mb-0 md:mt-2 border border-neutral-200 bg-white">
            ...
            {activeAssistant && (
                <div
                    ...
                    className="flex flex-row items-center text-black hover:opacity-50 mt-6 dark:text-white dark:border-neutral-600 py-3 px-4 dark:bg-[#051228] md:mb-0 md:mt-2 border border-neutral-200 bg-white">
                <IconRobot size={20}/>
                <button
