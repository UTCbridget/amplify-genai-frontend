            ...
            <div className="relative flex-1 overflow-hidden bg-white dark:bg-transparent">
                <>
                    ...
                    >
                        ...
                        {showExample.examples.length == 0 && (
                            <div className="justify-center items-center px-8 py-4 flex flex-col w-full text-black bg-white dark:text-white dark:bg-[#112e51]">
                                <div>
                        ...
                        {showExample.examples.map((example, index) => (
                            <>
                            <div>
                                <div className="px-8 py-4 flex flex-col w-full text-black bg-white dark:text-white dark:bg-[#112e51]">
                                    <div>
                            ...
                            <div>
                                <div className="px-8 py-4 flex flex-col w-full text-gray-600 dark:text-white bg-white dark:bg-[#112e51]">
                                    <div>
                                        <h1 className="mb-4 text-3xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">
